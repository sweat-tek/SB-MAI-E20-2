...
/**
 * The DefaultDrawingView is suited for viewing drawings with a small number of
 * Figures.
 *
 ...
 * @version 4.6 2009-04-25 Center drawing in view, if view is larger than the
 * canvas size.
 * <br>4.5.3 2008-09-01 Use an ordered set for the selected figures.
 * <br>4.5.2 2008-06-09 A DrawingView must not create Handle's, if it has no
 * DrawingEditor.
 ...
 * <br>4.2 2007-09-12 The DrawingView is now responsible for holding the
 * Constrainer objects which affect editing on this view.
 ...
 * <br>3.4 2007-04-09 Visualizes the canvas sgetChildCountof a Drawing by a
 * filled white rectangle on the canvasColor.
